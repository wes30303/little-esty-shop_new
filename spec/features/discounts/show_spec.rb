...
RSpec.describe 'Discounts Show Page' do
  ...
  it "visit my bulk discount show page and see the bulk discount's quantity threshold and percentage discount" do
  ...
  it "can see a link to edit the bulk discount and edit discount" do
    merchant1 = Merchant.create!(name: "Poke Retirement homes")
    merchant2 = Merchant.create!(name: "Happy Place ")
    ...
    expect(current_path).to eq("/discounts/#{discount1.id}/edit")
